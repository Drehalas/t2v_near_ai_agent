const CACHE_NAME = 'lending-app-v1.0.0'
const STATIC_CACHE_NAME = 'lending-static-v1.0.0'
const DYNAMIC_CACHE_NAME = 'lending-dynamic-v1.0.0'
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Lending App', options)
  )
})
